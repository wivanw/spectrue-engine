...
PRICING = {
    ModelID.MID: ModelPrice(0.14, 0.28),
    ModelID.NANO: ModelPrice(0.05, 0.40), # 0.00000005 * 1M = 0.05
...
cost_mono = calculate_cost(ModelID.MID, mono_input_tok, mono_output_tok)
...
cost_core = calculate_cost(ModelID.MID, core_input_tok, core_output_tok)
...
cost_enrich = calculate_cost(ModelID.NANO, enrich_input_tok_total, enrich_output_tok_total)
