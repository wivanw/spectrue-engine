"""Scientific consensus calculation domain logic."""

from __future__ import annotations

from typing import List, Any
from .model import ConsensusState


def calculate_consensus(evidence_list: List[Any]) -> ConsensusState:
    """
    ...
    for e in evidence_list:
        ...
        if stance in ("support", "SUPPORT"):
            supports += 1
            valid_evidence_count += 1
        elif stance in ("refute", "REFUTE"):
            refutes += 1
            valid_evidence_count += 1
