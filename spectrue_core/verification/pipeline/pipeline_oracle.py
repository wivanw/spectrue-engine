...
# Define shared constants for Oracle intents
ORACLE_CHECK_INTENT = {"news", "claim", "rumor", "general", "fact", "stat", "quote"}
ORACLE_SKIP_INTENT = {"opinion", "prediction", "analysis", "satire", "review", "personal_story"}
