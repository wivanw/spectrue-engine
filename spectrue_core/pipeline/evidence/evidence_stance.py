...
def count_stance_evidence(
    ...
    from spectrue_core.pipeline.evidence.evidence_explainability import get_tier_rank
...
def assign_claim_rgba(
    ...
    *,
    ...
    from spectrue_core.pipeline.scoring.rgba_aggregation import apply_conflict_explainability_penalty
    from spectrue_core.pipeline.mode import ScoringMode
    ...
    from spectrue_core.pipeline.evidence.evidence_explainability import norm_claim_id
